...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 295">
        <defs>
        ...
        <g fill="none">
            <path fill="#000" fill-opacity=".2"
                ...
                filter="url(#logosLinuxTuxk)" transform="translate(10)" />
            <path fill="#000"
            ...
            <path fill="#000" stroke="#000" stroke-width=".977"
            ...
            <path fill="url(#logosLinuxTux7)"
                ...
                transform="translate(10)" />
            <path fill="#000" stroke="#000" stroke-width="1.25"
            ...
            <path fill="url(#logosLinuxTuxb)"
                ...
                transform="translate(10)" />
            <path fill="url(#logosLinuxTuxc)" stroke="#E68C3F" stroke-width="6.25"
            ...
            <path fill="url(#logosLinuxTuxd)"
                ...
                transform="translate(10)" />
            <path fill="url(#logosLinuxTuxe)" stroke="#E68C3F" stroke-width="6.251"
            ...
            <path fill="url(#logosLinuxTuxh)"
                ...
                transform="translate(10)" />
            <path fill="url(#logosLinuxTuxi)" stroke="#E68C3F" stroke-width="3.75"
